...
<?php
    ...
    if (isset($_GET["submit"])) {
        ...
        foreach ($query as $data) {
            ...
            $output.= "<tr>
                <td class='col-sm-1'>{$data['sold_by']}</td>            
                <td class='col-sm-1'>{$formatted}</td>
                </tr>";
        }
        $format = array(
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">Reports - Cashier Sales Summary Report <small class="reports-range"><?php if(isset($from) && isset($to)){echo $from . " - ". $to; }?></small></div>
