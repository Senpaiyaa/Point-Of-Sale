...
<?php
    function create_item($stock) {
        ...
        $expense = '<a id="expense" class="pointer text-center" href="issue_item.php?product_id='.$stock_id.'"><span class="fa fa-save"></span> Issuing item</a>';
